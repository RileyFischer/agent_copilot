...
trgt_val = st.selectbox('Target Audience', ['empty nesters',' a newly married couple','looking to grow their family','first time home buyers'])
resp_len = st.number_input('Ad word limit', value=150, step=50)
ad_prompt = "Write a creative ad for "+(brnd_val)+" to run on "+(ptfm_val)+" aimed at potential home buyers who are "+(trgt_val)+" in "+str(city_val)+", "+str(cnty_val)+" county, "+str(stat_val)+"."
